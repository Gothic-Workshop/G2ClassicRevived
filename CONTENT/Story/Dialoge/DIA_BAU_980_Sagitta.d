...
FUNC VOID DIA_Sagitta_Teach_Info()
{
	...
	|| ( PLAYER_TALENT_ALCHEMY[POTION_Perm_STR_01] == FALSE)
	...
	if (PLAYER_TALENT_ALCHEMY[POTION_Perm_STR_01] == FALSE)
	{
		Info_AddChoice (DIA_Sagitta_Teach,B_BuildLearnString ("Essence of Strength", B_GetLearnCostTalent (other, NPC_TALENT_ALCHEMY, POTION_Perm_STR_01)),DIA_Sagitta_Teach_Perm_STR_01);
		talente = (talente + 1);
	};
...
FUNC VOID DIA_Sagitta_Teach_Perm_STR_01 ()
{
	B_TeachPlayerTalentAlchemy (self, other, POTION_Perm_STR_01);
	Info_ClearChoices (DIA_Sagitta_Teach);
};

FUNC VOID DIA_Sagitta_Teach_Perm_STR_02 ()
{
	B_TeachPlayerTalentAlchemy (self, other, POTION_Perm_STR_02);
	Info_ClearChoices (DIA_Sagitta_Teach);
};

FUNC VOID DIA_Sagitta_Teach_Perm_STR_03 ()
{
	B_TeachPlayerTalentAlchemy (self, other, POTION_Perm_STR_03);
	Info_ClearChoices (DIA_Sagitta_Teach);
};
