...
FUNC VOID STARTUP_NEWWORLD_PART_DRAGON_ISLAND_01 ()
{
	...
	{
		Wld_InsertNpc 	(DMT_TemplarAmbientH, 			"DI_DRACONIANAREA_22");		
		Wld_InsertNpc 	(DMT_TemplarAmbientH, 			"DI_DRACONIANAREA_08");		
	}
	else
	{
...
FUNC VOID STARTUP_NEWWORLD_PART_DRAGON_UNDEAD_01 ()
{
	...
	{
		Wld_InsertNpc 	(Skeleton_Lord, 	"DI_ARCHOL_SKELETON_01");	
		Wld_InsertNpc 	(Skeleton_Lord, 	"DI_ARCHOL_SKELETON_02");	
		Wld_InsertNpc 	(Skeleton_Lord, 	"DI_ARCHOL_SKELETON_03");	
		Wld_InsertNpc 	(Skeleton_Lord, 	"DI_ARCHOL_SKELETON_04");
	}
	else
	{
	...
	if (hero.guild == GIL_KDF)
	{
		Wld_InsertNpc	(DMT_TemplarAmbientL,	"DI_DRACONIANAREA_55");
		Wld_InsertNpc	(DMT_TemplarAmbientL,	"DI_DRACONIANAREA_55");
		Wld_InsertNpc	(DMT_TemplarAmbientM,	"DI_DRACONIANAREA_56");
		Wld_InsertNpc	(DMT_TemplarAmbientL,	"DI_DRACONIANAREA_56");
		Wld_InsertNpc	(DMT_TemplarAmbientM,	"DI_DRACONIANAREA_51");
		Wld_InsertNpc	(DMT_TemplarAmbientL,	"DI_DRACONIANAREA_51");
		Wld_InsertNpc	(DMT_TemplarAmbientM,	"DI_DRACONIANAREA_51");
	}
	else 
	{
...
FUNC VOID STARTUP_NEWWORLD_PART_DRAGON_FINAL_01 ()
{
	...
	if (hero.guild == GIL_KDF)
	{
		Wld_InsertNpc	(DMT_TemplarAmbientH,						"DI_UNDEADDRAGONTEMPEL_20");
		Wld_InsertNpc	(DMT_TemplarAmbientH,						"DI_UNDEADDRAGONTEMPEL_23");
	}
	else
	{
...
//----- Die Crew -----
	...
	{
		Wld_InsertNpc 	(KDW_439_Vatras_DI, 	"SHIP_DECK_01");
	};	
	...
	{
		Wld_InsertNpc 	(SLD_449_Lares_DI, 		"SHIP_DECK_01");

		if ( Diego_IsOnBoard != LOG_SUCCESS) 
			{
				B_StartOtherRoutine	(SLD_449_Lares_DI, "SittingShipDI");
			};
	};	
