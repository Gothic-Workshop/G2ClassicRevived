...
//-------------------------------------------------------------------------------------
//----------------------
var int Runen_1_permanent;
//----------------------
var int Runen_2_permanent;
//----------------------
var int Runen_3_permanent;
//----------------------
var int Runen_4_permanent;
//----------------------
var int Runen_5_permanent;
//----------------------
var int Runen_6_permanent;
//----------------------
...
FUNC VOID Use_Bookstand_Kreise_01_S1()		
{
	...
	{	
		...
		nDocID = 	Doc_Create		()			  ;							
					...
					if (Runen_1_permanent == FALSE)
					{
						B_GivePlayerXP (XP_BookstandRunes);
						Runen_1_permanent = TRUE;
					};
	};
};
//-------------------------------------------------------------------------------------
...
FUNC VOID Use_Bookstand_Kreise_02_S1()		
{
	...
	{	
		...
		nDocID = 	Doc_Create		()			  ;							
					...
					if (Runen_2_permanent == FALSE)
					{
						B_GivePlayerXP (XP_BookstandRunes);
						Runen_2_permanent = TRUE;
					};
...
FUNC VOID Use_Bookstand_Kreise_03_S1()		
{
	...
	{	
		...
		nDocID = 	Doc_Create		()			  ;							
					...
					if (Runen_3_permanent == FALSE)
					{
						B_GivePlayerXP (XP_BookstandRunes);
						Runen_3_permanent = TRUE;
					};
...
FUNC VOID Use_Bookstand_Kreise_04_S1()		
{
	...
	{	
		...
		nDocID = 	Doc_Create		()			  ;							
					...
					if (Runen_4_permanent == FALSE)
					{
						B_GivePlayerXP (XP_BookstandRunes);
						Runen_4_permanent = TRUE;
					};
...
FUNC VOID Use_Bookstand_Kreise_05_S1()		
{
	...
	{	
		...
		nDocID = 	Doc_Create		()			  ;							
					...
					if (Runen_5_permanent == FALSE)
					{
						B_GivePlayerXP (XP_BookstandRunes);
						Runen_5_permanent = TRUE;
					};
