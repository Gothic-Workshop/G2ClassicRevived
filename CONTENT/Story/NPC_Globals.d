...
func void  B_InitNpcGlobals ()
{
 ...
 //Die 4 Freunde
	...
	Gorn_DI			= Hlp_GetNpc(PC_Fighter_DI);
 	...
 	DiegoOW			= Hlp_GetNpc (PC_Thief_OW);
...
// ------ Banditen vom Gamestart
 ...
 //----NewWorld----
	...
	Vatras			= Hlp_GetNpc (KDW_439_Vatras);
	Pablo			= Hlp_GetNpc (MIL_319_Pablo);
	NOV607			= Hlp_GetNpc (NOV_607_Novize);
	Lares			= Hlp_GetNpc (SLD_449_Lares);
 ...
 //----OldWorld----
	Koch				= Hlp_GetNpc(STRF_1107_Chef);
	Bruder				= Hlp_GetNpc(PAL_2004_Bruder);
	PAL_Leiche1			= Hlp_GetNpc(PAL_2002_Silvestro);
	...
	VLK_Leiche1			= Hlp_GetNpc(GRD_4150_Leiche);
	VLK_Leiche2			= Hlp_GetNpc(GRD_4151_Leiche);
	VLK_Leiche3			= Hlp_GetNpc(GRD_4112_Den);
	...
	Bilgot			= Hlp_GetNpc(GRD_4120_Bilgot);	 
 	Brutus 			= Hlp_GetNpc(GRD_4100_Brutus);	 
	...
	HaupttorWache_4143		= Hlp_GetNpc(GRD_4143_HaupttorWache);	 
