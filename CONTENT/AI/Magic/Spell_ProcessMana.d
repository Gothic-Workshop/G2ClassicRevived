...
func INT Spell_ProcessMana (VAR INT manaInvested)
{
	...
	//Teleport-Runen
	if (activeSpell == SPL_PalTeleportSecret	)	{	return  Spell_Logic_TeleportAlle		(manaInvested); };
	if (activeSpell == SPL_TeleportSeaport		)	{	return  Spell_Logic_TeleportAlle		(manaInvested); };
	if (activeSpell == SPL_TeleportMonastery	)	{	return  Spell_Logic_TeleportAlle		(manaInvested); };
	if (activeSpell == SPL_TeleportFarm			)	{	return  Spell_Logic_TeleportAlle		(manaInvested); };
	if (activeSpell == SPL_TeleportXardas		)	{	return  Spell_Logic_TeleportAlle		(manaInvested); };
	if (activeSpell == SPL_TeleportPassNW		)	{	return  Spell_Logic_TeleportAlle		(manaInvested); };
	if (activeSpell == SPL_TeleportPassOW		)	{	return  Spell_Logic_TeleportAlle		(manaInvested); };
	if (activeSpell == SPL_TeleportOC			)	{	return  Spell_Logic_TeleportAlle		(manaInvested); };
	if (activeSpell == SPL_TeleportOWDemonTower)	{	return  Spell_Logic_TeleportAlle		(manaInvested); };
	if (activeSpell == SPL_TeleportTaverne		)	{	return  Spell_Logic_TeleportAlle		(manaInvested); };
	//Runen und Scrolls
	//Kreis 1
