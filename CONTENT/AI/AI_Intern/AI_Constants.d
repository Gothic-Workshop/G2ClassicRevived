...
//const int PERC_DIST_ORC_ACTIVE_MAX		= 2500; // original value
const int PERC_DIST_ORC_ACTIVE_MAX		= 1500; //
...
const int Race_Latino				= 2;
const int Race_Black				= 3;
const int Race_Sick					= 4;

const int BodyTex_Naked			= 0;
const int BodyTex_Tattoo		= 1;
const int BodyTex_Clothes		= 2;
const int BodyTex_ClothesA		= 3;
